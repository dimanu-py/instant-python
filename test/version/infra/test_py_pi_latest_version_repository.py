...
class TestPyPiLatestVersionRepository:
    _PYPI_URL = "https://pypi.org/pypi/instant-python/json"
    _ANY_VERSION = "1.0.0"

    def setup_method(self) -> None:
        self._http_client = Mimic(Mock, UrllibHttpClient)
        self._pypi_latest_version_repository = PyPiLatestLatestVersionRepository(self._http_client)
    ...
    def test_should_get_response_from_pypi(self) -> None:
        ...
        self._pypi_latest_version_repository.get_latest_version()
    ...
    def test_should_should_get_pypi_latest_version(self) -> None:
        ...
        latest_version = self._pypi_latest_version_repository.get_latest_version()
